...
DomainErrorTranslator._errorDictionary = {
  ...
  'CREATE_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat membuat comment baru karena terdapat properti dengan tipe data tidak sesuai'),
  ...
  'CREATE_REPLY.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat membuat reply baru karena terdapat properti dengan tipe data tidak sesuai'),
};
